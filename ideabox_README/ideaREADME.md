...
* We had already gotten delete functionality to work in the process of writing for local storage in iteration 2. We added star toggling functionality going but not beyond page load.
